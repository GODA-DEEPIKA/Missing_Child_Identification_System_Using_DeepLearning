...
def UploadAction(request):
     ...
     if request.method == 'POST' and request.FILES['t5']:
        ...
        filename = fs.save('D:/PROJECT/MissingChilds/MissingChildApp/static/photo/'+child_name+'.png', myfile)
        #if index == 0:
...
def ParentRegisterAction(request):
    if request.method == 'POST' and request.FILES['t9']:
        ...
        fs = FileSystemStorage()
        filename = fs.save('D:/PROJECT/MissingChilds/MissingChildApp/static/documents/'+filenames, myfile)
